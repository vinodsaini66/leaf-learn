...
path_to_images =input("Enter train image path :")
path_to_masks = input("Enter train image segmentents path : ")
...
filename = 'models/full_test_images_finalized_model_last.pkl'
